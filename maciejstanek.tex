...
\quote{Team--oriented and eager to learn C++ developer with 3+ years of full--time experience and an extraordinary attention to detail, seeking to grow as an engineer by helping Egnyte enhance and maintain their products.}
% \quote{``Programming enthusiast, maker and hacker, CLI freak, detail oriented engineer."}
...
\begin{cvskills}
  \cvskill
    ...
    {Modern C++, Google Test, Python} % Skills
  \cvskill
    {Tools} % Category
