...
\quote{Team--oriented and eager to learn C++ developer with 3+ years of full--time experience, an aptitude for hardware and an extraordinary attention to detail, seeking to grow as an engineer by helping Mobica create products that make a difference.}
% \quote{``Programming enthusiast, maker and hacker, CLI freak, detail oriented engineer."}
...
\makecvfooter
  {\today}
  {I hereby consent for my personal data to be processed by Mobica Limited Sp. z o.o.{\break}for the purposes of the recruitment process.}
  {1/1}
