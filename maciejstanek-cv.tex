...
\cvsection{Skills}
\begin{cvskills}
\cvskill{Modern C++}{\faStar\faStar\faStar\faStar\faStar[regular] with Std, Boost, Google Test, Clang toolchain, GDB, basics of CMake, basics of Qt}
\cvskill{Git}{\faStar\faStar\faStar\faStar\faStar[regular]}
\cvskill{Linux Shell}{\faStar\faStar\faStar\faStar\faStar[regular] native shell user}
\cvskill{Python}{\faStar\faStar\faStar[regular]\faStar[regular]\faStar[regular] for prototyping and automation}
	\cvskill{Other tools}{Jira, Phabricator, Confluence}
	\cvskill{Other technologies}{Tcl, Verilog}
\end{cvskills}
