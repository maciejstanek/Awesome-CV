...
\quote{Team--oriented and eager to learn C++ developer with 3+ years of full--time experience, an aptitude for hardware and an extraordinary attention to detail, seeking to grow as an engineer by helping Nokia create products that make a difference.}
% \quote{``Programming enthusiast, maker and hacker, CLI freak, detail oriented engineer."}
...
\makecvfooter
  ...
  % {Wyrażam zgodę na przetwarzanie moich danych osobowych przez Poland Sp. z o.o. \break w celu prowadzenia rekrutacji na aplikowane przeze mnie stanowisko.}
